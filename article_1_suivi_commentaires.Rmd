...
<!-- je dois relire l'article, monter mon conceptogramme en parallèle puis ensuite seulement enrichir mon introduction en profondeur. Ensuite, je vais à chaque transition rajouter du solide. Je peux en lisant, marquer les transitions en rouge !! 
Je peux maintenant voir comment je peux adresse le commentaire du 2-2 et surtout le rassurer dans ma réponse car ce 27 septembre, j'ai pas mal clarifié et structuré. Rien de nouveau dans le fond mais un contenu mieux assumé et prévisible.
-->
